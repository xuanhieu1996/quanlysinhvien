...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Dssinhvien_js__ = __webpack_require__(4);
...
var dssv = new __WEBPACK_IMPORTED_MODULE_0__Dssinhvien_js__["a" /* DsSinhVien */]();
function Themsinhvien (){
	...
	var sv = new __WEBPACK_IMPORTED_MODULE_1__Sinhvien_js__["a" /* SinhVien */](masv,hoten,cmnd,email,dienthoai);
	dssv.ThemSV(sv);
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = DsSinhVien;
function DsSinhVien() {
	this.mangSinhVien = [] ; 
	this.ThemSV = function(sv) {
		this.mangSinhVien.push(sv);
	};
}
...
function SinhVien(masv,hoten,cmnd,email,dienthoai) 
{
	this.masv = masv ; 
	this.hoten  = hoten ; 
	this.cmnd = cmnd;  
...
module.exports = __webpack_require__.p + "images/6b3e732fc79b.jpg";
